...
class EntityTest extends ApiTestCase
{
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/posts/1', 'GET');
...
JSON;
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/posts/12', 'GET');
    ...
    public function testPost()
    {
        ...
        $response = $this->sendRequest('http://127.0.0.1/posts/1', 'POST', $headers);
    ...
    public function testPut()
    {
        ...
        $headers  = ['Content-Type' => 'application/json', 'Authorization' => 'Bearer ' . $this->getAccessToken()];
        $response = $this->sendRequest('http://127.0.0.1/posts/1', 'PUT', $headers, $payload);
...
JSON;
        ...
        $expect = [
            ['ID' => 1, 'post_author' => 1, 'post_title' => 'foobar', 'post_content' => 'Welcome to WordPress. This is your first post. Edit or delete it, then start blogging!', 'post_status' => 'publish'],
        ];
    ...
    {
        $headers  = ['Content-Type' => 'application/json', 'Authorization' => 'Bearer ' . $this->getAccessToken()];
        $response = $this->sendRequest('http://127.0.0.1/posts/1', 'DELETE', $headers);
